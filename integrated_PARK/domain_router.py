...
_CHAT_OVERRIDE_PATTERNS = [
    ...
    "어떻게 쓰나요", "어떻게 쓰는", "어떻게 하는", "사용법", "도움말", "기능 안내", "기능 소개",
    "어떻게 돼", "어떻게 되나요", "어떻게 하면 돼",
    "뭐가 필요", "뭐 필요", "필요한 정보",
    "어떻게 이용", "이용 방법", "쓰는 방법",
    "뭐 하는", "뭐야", "뭔가요", "뭔지", "란 무엇",
    ...
    "기능 알려", "기능을 알려", "기능 설명",
    # 사용 방법 문의 — 입력값·활용법 질문
    "어떻게 활용", "어떻게 입력", "입력 방법", "뭘 입력", "무엇을 입력", "어떤 정보가 필요",
]
...
- admin: 행정 절차, 영업 신고, 허가, 서류, 관청 관련, 정부지원사업, 보조금, 지원금, 창업패키지, 정책자금 대출, 소상공인 융자, 신용보증, 고용지원, 채용장려금, 사업자등록, 위생교육, 보건증
...
- chat: 인사, 잡담, 서비스 기능·사용법 문의, "뭐 할 수 있어?" 류의 안내 요청, 지원 업종·지원 범위 문의, 특정 에이전트의 입력값·사용법을 묻는 질문, 서비스 범위 밖의 질문 (예: 맛집 추천, 지원하지 않는 업종 문의)
...
5. "창업 절차/신고/허가" → admin
6. 지원하지 않는 업종에 대한 질문, 맛집 추천, 시스템 질문 → chat
