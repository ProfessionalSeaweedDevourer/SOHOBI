...
export default function ChatPanel({
   ...
   return (
      <>
         ...
         {!isOpen && (
            <button
               className={`mv-chat-toggle group absolute bottom-[20px] z-[210] ${hasPopup || dongPanelOpen ? "left-[12px]" : "right-[14px]"} rounded-full shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-105 flex items-center gap-3 px-5 py-3.5 cursor-pointer border-2 border-white/20 dark:border-white/30`}
               onClick={onToggle}
               title="에이전트와 대화"
            >
