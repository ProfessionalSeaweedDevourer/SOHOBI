...
| 3 | `AZURE_SIGNOFF_DEPLOYMENT=gpt-5-nano` | DeploymentNotFound | gpt-5-nano는 <AZURE_OPENAI_RESOURCE>에 미배포 |
...
client = openai.AsyncOpenAI(
    base_url="https://<AZURE_OPENAI_RESOURCE>.services.ai.azure.com/api/projects/ejp-9638/openai/v1",
    api_key="placeholder",
