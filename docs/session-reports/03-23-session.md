...
| 파일 | 변경 내용 |
|------|-----------|
| `frontend/.env.production` | `VITE_API_URL=https://<PREVIOUS_BACKEND_HOST>` 추가 |
...
az role assignment create \
  ...
  --scope .../Microsoft.CognitiveServices/accounts/<AZURE_OPENAI_RESOURCE>
```
코드 변경 없음.
